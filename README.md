...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly create ff-discord-bot-e488
  fly create ff-discord-bot-e488-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app ff-discord-bot-e488
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app ff-discord-bot-e488-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'ff-discord-bot-e488-staging' does not match app name in config file 'ff-discord-bot-e488'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name ff-discord-bot-e488-db
  fly postgres attach --postgres-app ff-discord-bot-e488-db --app ff-discord-bot-e488

  fly postgres create --name ff-discord-bot-e488-staging-db
  fly postgres attach --postgres-app ff-discord-bot-e488-staging-db --app ff-discord-bot-e488-staging
  ```
